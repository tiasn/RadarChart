...
//  RadarChart
//
//  Created by LTX on 2017/8/29.
//  Copyright © 2017年 LTX. All rights reserved.
//

#import "ViewController.h"
#import "RadarChart-Bridging-Header.h"
#import "RadarChart-Swift.h"
...
- (void)viewDidLoad {
    ...
    activities = @[ @"行为偏好", @"身份特质", @"履约能力", @"信用历史", @"人脉关系" ];
...
//                     ];
    ...
    _chartView = [[RadarChartView alloc] initWithFrame:CGRectMake(0, 50, 400, 400)];
//    _chartView.backgroundColor = [UIColor yellowColor];
    _chartView.delegate = self;
    _chartView.descriptionText = @"信用结构图";
    _chartView.descriptionTextColor = UIColor.redColor;
    
//    _chartView.chartDescription.enabled = NO;
    _chartView.webLineWidth = 0.5; // 每个项目的指示线
    _chartView.innerWebLineWidth = 1.0;
    _chartView.webColor = UIColor.blackColor;
    _chartView.innerWebColor = UIColor.lightGrayColor;
    _chartView.webAlpha = 1.0;
    
    [self.view addSubview:_chartView];
//    
//    ChartMarkerView *marker = (RadarMarkerView *)[RadarMarkerView viewFromXib];
...
//    int cnt = 5;
    ...
    [entries1 addObject:[[RadarChartDataEntry alloc] initWithValue:50]];
    [entries1 addObject:[[RadarChartDataEntry alloc] initWithValue:60]];
    [entries1 addObject:[[RadarChartDataEntry alloc] initWithValue:70]];
    [entries1 addObject:[[RadarChartDataEntry alloc] initWithValue:80]];
    [entries1 addObject:[[RadarChartDataEntry alloc] initWithValue:90]];


    [entries2 addObject:[[RadarChartDataEntry alloc] initWithValue:40]];
    [entries2 addObject:[[RadarChartDataEntry alloc] initWithValue:40]];
    [entries2 addObject:[[RadarChartDataEntry alloc] initWithValue:40]];
    [entries2 addObject:[[RadarChartDataEntry alloc] initWithValue:40]];
    [entries2 addObject:[[RadarChartDataEntry alloc] initWithValue:40]];
...
//    }
    ...
    set2.fillColor = [UIColor colorWithRed:125/255.0 green:229/255.0 blue:255/255.0 alpha:1.0];
